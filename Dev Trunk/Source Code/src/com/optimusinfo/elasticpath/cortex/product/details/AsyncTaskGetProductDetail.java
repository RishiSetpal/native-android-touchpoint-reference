...
/**
 * This is asynchronous task to get the product details
 * 
 * @author Optimus
 * 
 */
public class AsyncTaskGetProductDetail extends AsyncTask<Void, Void, String> {
	 ...
	 *            navigation task
	 */
	public AsyncTaskGetProductDetail(Context current, String url, String token,
			String contentTypeString, String contentTypeValue,
			String authoriztionString, String accessTokenInitializer,
			ListenerGetProductDetails listener) {
		mCurrent = current;
		URL = url;
		accessToken = token;
